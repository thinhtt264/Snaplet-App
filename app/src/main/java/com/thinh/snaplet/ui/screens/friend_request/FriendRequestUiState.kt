...
/**
 * FriendRequestUiState - UI state for friend request overlay
 * 
 * Enterprise Pattern: Sealed class for type-safe state management
 * Complete state representation: Hidden, Loading, Visible, Error
 */
sealed class FriendRequestUiState {
     ...
     * 
     * @param userName Username that failed to load
